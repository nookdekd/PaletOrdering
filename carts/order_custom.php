...
<div class="container">
      <div class="container mt-5">
        <div class="section-title">
          <center><h2><center><h2>รายการสินค้าที่สั่งทำของ <?php echo $_SESSION['fname']; ?></h2></center></h2></center>
        </div>
        </div>
<div class="container">
<?php
...
<a class="btn btn-success" href="customproduct" role="button">
สั่งทำสินค้า</a>
</div>
<thead>
<tr>
...
ไม่สามารถดำเนินการได้<i class="fa fa-credit-card"></i></a>
</td>
<?php endif; ?>
</tr>
<?php }}
...
{
    $sql = $updateuser->fetchdata_order_custom($userid);
...
<td>รอดำเนินการ</td>
<?php endif; ?> 
<?php if($row['status_id']==9) : ?>
<td>กำลังดำเนินการ</td>
<?php endif; ?> 
<?php if($row['status_id']==8) : ?>
<td>การสั่งทำไม่สำเร็จ</td>
<?php endif; ?> 
<td><span class="badge badge-secondary" style="background-color:<?php echo $row['color']; ?>"><?php echo $row['status_name']; ?></span></td>
<?php if($row['status_id']==0) : ?>
<td>
<a class="btn btn-light" href="#" role="button">
ไม่สามารถดำเนินการได้ <i class="fa fa-minus-circle"></i></a>
</td>
<?php endif; ?> 
<?php if($row['status_id']==9) : ?>
<td>
<a class="btn btn-success" href="config/updatecart.php?itemId=<?php echo $row['id']; ?>" role="button">
สั่งซื้อ <i class="fa fa-plus-circle"></i></a>
</td>
<?php endif; ?> 
<?php if($row['status_id']==8) : ?>
<td>
