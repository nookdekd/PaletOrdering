<?php 
    ...
    define('DB_NAME', 'thewooding'); // Database Name
    ...
    class DB_con {
        ...
        public function deletecustom($cid) {
            $deleterecord = mysqli_query($this->dbcon, "DELETE FROM products WHERE id = '$cid'");
            return $deleterecord;
        }
        ...
        public function dontallow($cid,$status_id) {
        ...
        public function allowcustom($product_id, $product_price, $status_id) {
            $result = mysqli_query($this->dbcon, "UPDATE products SET 
        ...
        public function fetchdata_product() {
            $result = mysqli_query($this->dbcon, "SELECT * FROM products where userid=0 and status_id = 0");
            return $result;
        }
        ...
        public function fetchdata_order_custom($userid) {
            $result = mysqli_query($this->dbcon, "SELECT * FROM products WHERE userid = '$userid'");
            return $result;
        }

        public function fetchdata_order_detail_admin($userid) {
            $result = mysqli_query($this->dbcon, "SELECT orders.id,order_date,fullname,status_name,pic FROM orders,tblusers,status_cash where  status_cash.status_id=orders.status_id  and tblusers.id=orders.cust_id");
            return $result;
        }
