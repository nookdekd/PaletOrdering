<?php 
    ...
    $sql8 = "SELECT product_code, product_price , product_name,count(order_details.product_id) as ccc FROM order_details,products WHERE order_details.id and order_details.product_id=products.id group by order_details.product_id";
          ...
          <div class="row">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title">สินค้าขายดี</h4>
                </div>
