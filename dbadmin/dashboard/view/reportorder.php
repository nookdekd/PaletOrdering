<?php 
 ...
 $page = 1;
  ...
  $sql = "SELECT orders.id ,order_date,fullname,status_name,orders.status_id,color,report_id , pic FROM orders,tblusers,status_cash,cashout 
  where cashout.order_id=orders.id and status_cash.status_id=orders.status_id and tblusers.id=orders.cust_id order by orders.id DESC limit {$start} , {$perpage}  ";
...
<td><a href="/thewooding/dbadmin/assets/img/bill/<?php echo $row['pic']; ?>"><img height="70" width="70" src="/thewooding/dbadmin/assets/img/bill/<?php echo $row['pic']; ?>" border="0"></a></td>
</tr>
<?php }}
else
{
